...
const Sidebar = () => {
    ...
    return (
        <div className={`h-screen flex flex-col justify-between items-center p-5 border-2 rounded-3xl transition-all duration-300 ${toggle ? 'w-[6rem]' : 'w-[18rem]'}`}>
            {/* Top Section */}
            <div className="top flex flex-col items-center w-full">
                <div className='w-full flex justify-start'>
                    <Button onClick={handleSidebarToggle} sx={{ minHeight: '2rem', minWidth: '2rem' }}>
            ...
            <div className="mid flex flex-col my-3 items-center w-full">
                {[
                    { icon: <AllInboxIcon sx={{ height: 50, width: 50 }} />, label: "Dashboard" },
                    { icon: <PersonIcon sx={{ height: 50, width: 50 }} />, label: "Profile" },
            ...
            <div className="bottom flex justify-center w-full">
                <Button onClick={handleSignOut}
                    ...
                    <LogoutIcon sx={{ height: 50, width: 50 }} />
